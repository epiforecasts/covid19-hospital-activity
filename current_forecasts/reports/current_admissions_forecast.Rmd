...
return_region_plots <- function(region = "North West"){
  ...
  return(list(current_forecast = g_current,
              scatter = g_scatter,
              past_7days = g_past7,
...
### Current forecast, ribbon {.tabset .tabset-pills}
...
### Forecast increase, maps {.tabset .tabset-pills}
...
### Summary, table {.tabset .tabset-pills}
...
## By NHS region {.tabset}

### East of England {.tabset .tabset-pills}
...
### North East and Yorkshire {.tabset .tabset-pills}
...
### North West {.tabset .tabset-pills}
...
### South East {.tabset .tabset-pills}
...
### South West {.tabset .tabset-pills}
...
plot_forecast_bars(observed = admissions %>%
  ...
  scale_y_continuous(limits = c(0, NA), breaks = integer_breaks()) +
  labs(title = "Top 25 Trusts with most admissions in last 28 days",
       subtitle = "Past 7-day ahead forecasts, ensemble model") +
  theme(legend.position = "none")
