...
forecast_date <- as.Date("2021-05-09")
utla_names <- c("Bolton",
...
The current forecast date is **`r format.Date(forecast_date, format = "%d %B")`**, showing data until **`r format.Date(max(admissions$date), format = "%d %B")`**.
